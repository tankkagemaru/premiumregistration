...
export const en = {
  ...
  status: {
    ...
    complete: "Complete",
    history: "History",
    offerTitle: "Your offer letter",
    offerSub: "Your offer letter is ready. Download it, then confirm you have received and read it.",
    offerDownload: "Download offer letter",
    offerAck: "I have received and read my offer",
  ...
  options: {
    ...
    studyModes: {
      ...
      research: "Research",
      mixed: "Mixed mode",
      odl: "Open Distance Learning (ODL)",
      any: "Any / not sure",
    },
    educationLevels: {
